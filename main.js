...
me.family = ['Lila', 'Persephone', 'Garvey'];
console.log(me);
...
var myString = "Lauren's appetizer is " + invitees.adults[2].dinnerChoice[0] + ". She will be eating " + invitees.adults[2].dinnerChoice[1] + " for dinner. She will be having " + invitees.adults[2].dinnerChoice[2] + " for dessert.";
...
jsWorkshop.classmates = ["Jill", "Jane", "Emily", "Bob", "Carrie"];
...
books.ISBN22222.dateRead = "yesterday";
books.ISBN33333.dateRead = "sometime ago";
books.ISBN44444.dateRead = "never";
